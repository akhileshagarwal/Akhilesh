...
class Tree {
	...
	private void VerticalSumUtil(TreeNode root, int horizontalDistance, HashMap<Integer, Integer> hM) {
...
public class VerticalSum {
  ...
  */
		...
		root.right().setRight(new TreeNode(25));
		root.left().right().setLeft(new TreeNode(10));
		root.left().right().setRight(new TreeNode(14));
